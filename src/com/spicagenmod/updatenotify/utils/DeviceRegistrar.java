...
import com.spicagenmod.updatenotify.MainActivity;

public class DeviceRegistrar {
    public static final String SENDER_ID = "sm.c2dm@gmail.com";
    public static final String STATUS_EXTRA = "Status";
    public static final int REGISTERED_STATUS = 1;
    public static final int UNREGISTERED_STATUS = 2;

    private static final String TAG = "SMUpdateNotify-DeviceRegistrar";
    ...
    private static HttpResponse makeRegisterRequest(Context context, String deviceRegistrationID) throws Exception {
        ...
        params.add(new BasicNameValuePair("register", "register"));

        RegistrationClient client = new RegistrationClient();
        return client.serverRequest(params);
    }
    ...
    private static HttpResponse makeUnregisterRequest(Context context, String deviceRegistrationID) throws Exception {
        ...
        params.add(new BasicNameValuePair("register", "unregister"));
